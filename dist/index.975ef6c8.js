...
var _fetchAxiosImgJs = require("./js/fetchAxiosImg.js");
var _renderImgJs = require("./js/renderImg.js");
var _refs = require("./js/refs");
(0, _refs.refs).inputEl.addEventListener("submit", onSearchImg);
(0, _refs.refs).btnLoad.addEventListener("click", onBtnloadClick);
addClassVH();
const newApiService = new (0, _fetchAxiosImgJs.ApiService)();
...
async function onSearchImg(event) {
    ...
    (0, _renderImgJs.resetGallery)();
    const searchQuery = event.target.elements.searchQuery.value.trim();
    if (!searchQuery) {
        (0, _notiflixDefault.default).Notify.failure("Please type something.");
        addClassVH();
        return;
    }
    newApiService.query = searchQuery;
    const { data: { hits , totalHits  } ,  } = await newApiService.fetchImages();
...
function checkLastPage(totalHits) {
    if (newApiService.page >= Math.ceil(totalHits / newApiService.perPage)) addClassVH();
    else removeClassVH();
}
function onScroll() {
...
function addClassVH() {
    (0, _refs.refs).btnLoad.classList.add("visually-hidden");
}
function removeClassVH() {
    (0, _refs.refs).btnLoad.classList.remove("visually-hidden");
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./js/fetchAxiosImg.js":"iuVf2","./js/renderImg.js":"exRJV","./js/refs":"2WoF2"}],"gkKU3":[function(require,module,exports) {
...
},{}],"kaxSc":[function() {},{}],"iuVf2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"exRJV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderImg", ()=>renderImg);
parcelHelpers.export(exports, "resetGallery", ()=>resetGallery);
...
`).join("");
    (0, _refs.refs).galleryEl.insertAdjacentHTML("beforeend", markup);
}
function resetGallery() {
    (0, _refs.refs).galleryEl.innerHTML = "";
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./refs":"2WoF2"}],"2WoF2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
